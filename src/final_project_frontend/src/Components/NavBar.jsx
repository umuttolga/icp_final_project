        ...
        <div className={container}>
            <div className={logoSection}>
                <div className={navBarText}>
                    <img className="w-10 h-10 bg-blend-screen" src={logo} alt="logo Img" />
                    <div onClick={() => setShowProposal(false)} className={navBarText + underlineStyle}>ChainCortex</div>
                </div>
            </div>
            <div className="flex items-center gap-x-2">

                <div onClick={() => setShowProposal(true)} className={navBarText + underlineStyle}>Proposals</div>
            </div>
        </div>
